...
def main(config):
    ...
    #                       payload_coder_rs=config['payload_coder_rs'],
    #                       wide_coder=config['wide_coder'],
    #                       payload_coder_vt_syndrome=config['payload_coder_vt_syndrome'],
    ...
    if config['do_decode']:
        ...
        decoder = Decoder(barcode_len=config['barcode_len'],
                          ...
                          kmer_vector_representation_to_mer_representation=config['algorithm_config']
